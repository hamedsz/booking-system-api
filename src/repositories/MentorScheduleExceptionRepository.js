...
export default class MentorScheduleExceptionRepository extends AbstractRepository {
  constructor() {
    super();
    this.model = db.MentorScheduleException;
  ...
  betweenDates(from, to) {
    this.filters.date = { [Op.between]: [from, to] };
    return this;
  }
